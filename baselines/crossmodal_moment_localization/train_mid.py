...
from baselines.crossmodal_moment_localization.inference_mid import eval_epoch, start_inference
...
def start_training():
    ...
    MODEL_CLS = None 
    if opt.model_type == "xml":
        MODEL_CLS = XML
    elif opt.model_type == "xml_middle":
        MODEL_CLS = XML_MIDDLE
    else:
