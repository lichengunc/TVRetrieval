...
from baselines.crossmodal_moment_localization.model_xml_early import XML_EARLY
...
from baselines.crossmodal_moment_localization.inference_early import eval_epoch, start_inference
...
def start_training():
    ...
    assert opt.model_type == "xml_early", f"We do not support {opt.model_type}"
    model = XML_EARLY(model_config)
